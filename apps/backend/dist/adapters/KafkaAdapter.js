...
var KafkaProducer = /** @class */ (function () {
    ...
    KafkaProducer.prototype.send = function (topic, key, value) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var KafkaConsumer = /** @class */ (function () {
    function KafkaConsumer(kafka, groupId) {
    ...
    KafkaConsumer.prototype.subscribe = function (topic, fromBeginning) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    KafkaConsumer.prototype.onMessage = function (handler) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.consumer.run({
                            eachMessage: function (_a) { return __awaiter(_this, [_a], void 0, function (_b) {
                                ...
                                return __generator(this, function (_c) {
                                    switch (_c.label) {
                                        case 0: return [4 /*yield*/, handler(message)];
                                        case 1:
                                            _c.sent();
                                            return [2 /*return*/];
                                    }
