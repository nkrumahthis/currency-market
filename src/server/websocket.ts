...
import { Order, Trade, OrderBook } from "@/types";
...
type MessagePacket = {
	type: "order" | "trade" | "orderbook" | "orderResult" | "orderBookUpdate" | "error";
	payload: Order | Trade | OrderBook | OrderResult | OrderBookUpdate | ErrorPayload;
	timestamp: number;
};
...
class WebSocketHandler {
    ...
    broadcastOrderBook() {
        ...
        const marketPrice = this.matchingEngine.getMarketPrice()!;
